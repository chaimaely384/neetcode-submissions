...
#using set again :
# thsi solution feels more understandable but higher complexity
        ...
        for sqr in range(9):
            ...
            for i in range(3):
                for j in range(3):
                    row=(sqr//3)*3+i # row offset
                    col=(sqr%3)*3+j # here why % ? its the right Column offset
                    if board[row][col]==".":
                        continue
